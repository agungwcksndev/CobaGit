...
?>
	<div class="panel panel-headline">
		<div class="panel-heading">
			...
			<div class="right">
				<a href="<?php echo site_url('kbagian/input'); ?>" class="uk-button uk-button-primary uk-button-small">Tambah Pegawai</a><br></br>
			</div>
		</div>
	</div>
					...
					<div class="panel-body">
						<table id="pegawai" class="table table-striped">
							...
							<tr>
                                ...
                                <td>
                                <a href="<?php echo site_url('kbagian/SuratDosen/'.$u->NIP); ?>" class="uk-button uk-button-primary uk-button-small"><span class="lnr lnr-book "></span>
									</a> 
                                </td>
								<td>
								
									<a href="<?php echo site_url('kbagian/update/'.$u->NIP); ?>" class="uk-button uk-button-primary uk-button-small"><span class="lnr lnr-pencil "></span>
									</a> 
									<a href="<?php echo site_url('kbagian/hapus/'.$u->NIP); ?>" onclick="return deletechecked();" class="uk-button uk-button-danger uk-button-small"><span class="lnr lnr-trash"></span></a> 
