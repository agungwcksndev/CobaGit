		...
		<div>
			<div class="uk-button-group">
                ...
                <?php 
                            ...
                            ?>
				<a href="<?php echo site_url('kaur/rekapsurat/'.$b->NIP); ?>" class="uk-button uk-button-danger" uk-icon="settings">Tampil Data Perbulan</a><?php ?>
			</div>
		</div><br>
                        ...
                        <div class="">
                            <div class="uk-card uk-card-default">
                                <div class="uk-card-body">
                                    <form class="uk-grid-small" uk-grid action="<?php echo site_url('kaur/PencarianSurat');?>" method="get">
