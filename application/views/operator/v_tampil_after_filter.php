                        ...
                        <div class="">
                            <div class="uk-card uk-card-default">
                                <div class="uk-card-body">
                                    <form class="uk-grid-small" uk-grid action="<?php echo site_url('operator/filter_surat');?>" method="get">
					...
					<div class="">
						<table id="surattugas" class="table table-striped">
							...
							<tr>
								...
								<td><?php echo anchor('operator/detail_surat/'.$u->Nomor_Surat,$u->Perihal) ?></td>
								...
								<td>
									...
									<a href="<?php echo site_url('operator/tampil_form_edit_surat/'.$u->Nomor_Surat); ?>" class="uk-button uk-button-primary uk-button-small"><span class="lnr lnr-pencil "></span>
									</a> 
									<a href="<?php echo site_url('operator/hapus_surat_tugas/'.$u->Nomor_Surat); ?>" onclick="return deletechecked();" class="uk-button uk-button-danger uk-button-small"><span class="lnr lnr-trash"></span></a> 
