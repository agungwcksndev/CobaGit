	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					<div class="panel-body">
					<a href="<?php echo site_url('operator/tampil_form_tambah_pegawai/'.$b->Nomor_Surat); ?>" class="uk-button uk-button-primary uk-button-small"><span class="lnr lnr-plus-circle "></span>Tambah Pegawai</a><br></br>
						<table id="surattugas" class="table table-striped">
							...
							<tr>
								...
								<td>
									...
									<a href="<?php echo site_url('operator/tampil_form_edit_pegawai/'.$u->Nomor_Surat.'/'.$u->NIP); ?>" class="uk-button uk-button-primary uk-button-small"><span class="lnr lnr-pencil"></span></a> 
									<a href="<?php echo site_url('operator/hapus_pegawai/'.$u->Nomor_Surat.'/'.$u->NIP); ?>" onclick="return deletechecked();" class="uk-button uk-button-danger uk-button-small"><span class="lnr lnr-trash"></span></a> 
