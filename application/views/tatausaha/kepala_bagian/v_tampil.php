...
<div class="main-content">
	<div class="container-fluid">
        ...
        <center>
            ...
            <span uk-icon="settings"></span>FILTER</button></center><br>
                        ...
                        <div class="">
                            <div class="uk-card uk-card-default">
                                <div class="uk-card-body">
                                    <form class="uk-grid-small" uk-grid action="<?php echo site_url('kbagian/filter_surat');?>" method="get">
					...
					<div class="panel-body">
						<table id="surattugas" class="table table-striped">
							...
							<tr>
								...
								<td><?php echo anchor('kbagian/detail_surat/'.$u->Nomor_Surat,$u->Perihal) ?></td>
								<td><?php echo $u->Link_url ?></td>
								<td><?php echo $u->Ket ?></td>
								<td>
								
									<a href="<?php echo site_url('kbagian/tampil_form_edit_surat/'.$u->Nomor_Surat); ?>" class="uk-button uk-button-primary uk-button-small"><span class="lnr lnr-pencil "></span>
									</a> 
									<a href="<?php echo site_url('kbagian/hapus_surat_tugas/'.$u->Nomor_Surat); ?>" onclick="return deletechecked();" class="uk-button uk-button-danger uk-button-small"><span class="lnr lnr-trash"></span></a> 
