...
<div class="panel panel-headline">
    <div class="panel-heading">
        ...
        <p uk-margin>
				...
				<a href="<?php echo site_url('admin/rekapsurat/'.$b['NIP']); ?>" class="uk-button uk-button-small uk-button-danger" uk-icon="calendar"></a><?php ?>
			</div>  
        </p>
    </div>
</div>
 ...
 <?php 
   ...
   ?>
        ...
        <div class="uk-modal-footer uk-text-right">
            ...
            <a href="<?php echo site_url('admin/excelsuratpegawaiperbulan/'.$NIP.'/'.$bulanModal); ?>" class="uk-button uk-button-primary">Cetak
									</a> 
