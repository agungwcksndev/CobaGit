...
<div class="panel panel-headline">
						<div class="panel-heading">
                            ...
                            <p>Staff dan Dosen</p>
                            <div class="right">
        <a href="<?php echo site_url('admin/input'); ?>" class="uk-button uk-button-primary uk-button-small">Tambah Pegawai</a><br></br>
					...
					<div class="container-fluid">
						<table id="pegawai" class="table table-striped">
							...
							<tr>
                                ...
                                <td>
                                <a href="<?php echo site_url('admin/Surat/'.$u->NIP); ?>" class="uk-button uk-button-default uk-box-shadow-medium ">OPEN</span>
									</a> 
                                </td>
								<td>
