			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<div class="col-md-6">	
							...
							<p class="panel-subtitle">Kepala Urusan : <?php echo $urusan?></p>
						...
						<div class="panel-body">
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											...
											<span class="title">Jumlah Pegawai <br><?php echo $urusan?></span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
							...
							<div class="row">
								...
								<div class="col-md-3">
								<div>
								<form class="uk-margin-large" id="myform" method="post" action="<?php echo site_url('kaur/indeks');?>">
									<div class="uk-margin">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title"><span class="uk-label uk-label-success">Staff <?php echo $sub_bagian?></span><br> dengan surat terbanyak</h3>
								<div class="right">
									<button type="button" class="btn-toggle-collapse"><i class="lnr lnr-chevron-up"></i></button>
									<button type="button" class="btn-remove"><i class="lnr lnr-cross"></i></button>
								</div>
							...
							<div class="panel-footer">
								<div class="row">
									...
									<div class="col-md-6 text-right"><a href="<?php echo base_url('kaur/rekap');?>" class="btn btn-primary">Lihat Semua</a></div>
								</div>
							</div>
						</div>
						<!-- END MULTI CHARTS -->
