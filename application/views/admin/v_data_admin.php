...
<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title"><span>Admin</span></h3>
                            <p>Data Admin & Operator</p>
                            <div class="right">
        <a href="<?php echo site_url('admin/tambah_admin'); ?>" class="uk-button uk-button-primary uk-button-small">Tambah Admin</a><br></br>
						...
						<table id="surattugas" class="table table-striped">
							...
							<tr>
								...
								<td>
									...
									<a href="<?php echo site_url('admin/hapus_operator/'.$u->username); ?>" onclick="return deletechecked();" class="uk-button uk-button-danger uk-button-small"><span class="lnr lnr-trash"></span></a> 
