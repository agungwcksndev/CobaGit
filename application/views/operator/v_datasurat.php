...
<div class="panel panel-headline">
    <div class="panel-heading">
        ...
        <p uk-margin>
				...
				<a href="<?php echo site_url('operator/rekapsurat/'.$b['NIP']); ?>" class="uk-button uk-button-small uk-button-danger" uk-icon="calendar"></a><?php ?>
			</div>  
        </p>
    </div>
</div>
 ...
 <?php 
   ...
   ?>
        <div class="uk-flex-top uk-modal-container modal fade" id="modal_edit<?php echo $NIP;?><?php echo $bulanModal;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="uk-modal-header">
                    <h3 class="">Rincian Rekap Surat Tugas [<?php echo $dt->format('F');?>]</h3>
                </div>
        ...
        <div class="uk-modal-footer uk-text-right">
            ...
            <a href="<?php echo site_url('operator/excelsuratpegawaiperbulan/'.$NIP.'/'.$bulanModal); ?>" class="uk-button uk-button-primary">Cetak
									</a> 
