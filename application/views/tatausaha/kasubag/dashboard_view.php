			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<div class="col-md-6">	
							<p class="panel-subtitle">Kepala Sub Bagian : <?php echo $sub_bagian?></p>
						...
						<div class="panel-body">
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											...
											<span class="title">Jumlah Pegawai <?php echo $sub_bagian?></span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
							...
							<div class="row">
								...
								<div class="col-md-3">
								<div>
								<form class="uk-margin-large" id="myform" method="post" action="<?php echo site_url('kasubag/indeks');?>">
									<div class="uk-margin">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title"><span class="uk-label uk-label-success">Staff <?php echo $sub_bagian?></span> dengan surat terbanyak</h3>
								<div class="right">
									<button type="button" class="btn-toggle-collapse"><i class="lnr lnr-chevron-up"></i></button>
									<button type="button" class="btn-remove"><i class="lnr lnr-cross"></i></button>
								</div>
							...
							<div class="panel-footer">
								<div class="row">
									...
									<div class="col-md-6 text-right"><a href="<?php echo base_url('kasubag/rekap');?>" class="btn btn-primary">Lihat Semua</a></div>
								</div>
							</div>
						</div>
						<!-- END MULTI CHARTS -->
					...
					<div class="col-md-6">
						...
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title"><span class="uk-label uk-label-warning">Staff <?php echo $sub_bagian?></span> dengan surat terendah</h3>
								<div class="right">
									<button type="button" class="btn-toggle-collapse"><i class="lnr lnr-chevron-up"></i></button>
									<button type="button" class="btn-remove"><i class="lnr lnr-cross"></i></button>
								</div>
							...
							<table class="table table-striped">
									...
									<?php 
										$no = 1;
										foreach($surat_terendah as $u){ ?>
										<tr>
											<td><?php echo $no++ ?></td>
											<td><span class=""><?php echo $u['Nama'] ?></span></td>
											<td><?php echo $u['NIP']?></td>
											<td><?php echo $u['jumSuratBagianTerendah'] ?></td>
										</tr>
