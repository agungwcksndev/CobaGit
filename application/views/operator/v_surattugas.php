                    ...
                    <tr>
                        ...
                        <div class="uk-inline"> 
                            ...
                            <ul class="uk-nav uk-dropdown-nav">
                                <li class="uk-active "><a href="<?php echo site_url('operator/excelsurattugas'); ?>"><span class="uk-label uk-label-success fa fa-file-excel-o"> EXCEL</span></a></li>
                                <li><a href="<?php echo site_url('operator/pdfsurattugas'); ?>"><span class="uk-label uk-label-warning fa fa-file-pdf-o"> PDF</span></a></li>
                            </ul>
                            </div>
                        </div>
