                        ...
                        <div class="">
                            <div class="uk-card uk-card-default">
                                <div class="uk-card-body">
                                      <form action="<?php echo site_url('Kbagian/Filter');?>" method="POST">
                                        <fieldset class="uk-fieldset">
                                            ...
                                            <div class="uk-margin">
                                                <a href="<?php echo site_url('Kbagian/PegawaiTU'); ?>">Reset</a>
                                            </div>
                                    </form>
                                </div>
                            </div>
					...
					<div class="panel-body">
						...
						<table id="pegawai" class="table table-striped">
							...
							<tr>
                                ...
                                <a href="<?php echo site_url('Kbagian/Surat/'.$u->NIP); ?>" class="uk-button uk-button-default uk-box-shadow-medium ">OPEN</span>
									</a> 
                                </td>
							</tr>
							<?php } ?>
