                        ...
                        <div class="">
                            <div class="uk-card uk-card-default">
                                <div class="uk-card-body">
                                    <form action="<?php echo site_url('kasubag/Pencarian');?>" method="POST">
                                        <fieldset class="uk-fieldset">
                                            ...
                                            <div class="uk-margin">
                                                <div class="uk-position-relative">
                                                    ...
                                                    <input name="Tanggal_Surat"  placeholder="Tahun" class="uk-input" required  >
                                                </div>
                                            </div>
                                            ...
                                            <div class="uk-margin">
                                                <a href="<?php echo site_url('kasubag/rekap'); ?>">Reset</a>
                                            </div>
                                    </form>
                                </div>
                            </div>
