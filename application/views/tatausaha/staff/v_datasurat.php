    ...
    <div class="panel-heading">
        ...
        <p uk-margin>
				<a uk-toggle="target: #toggle-usage" class="uk-button uk-button-small uk-button-secondary"><span uk-icon="settings"></span></a>
				 ...
				 <a href="<?php echo site_url('staff/rekapsurat/'.$b['NIP']); ?>" class="uk-button uk-button-small uk-button-danger" uk-icon="calendar"></a><?php ?>
                        ...
                        <div class="">
                            <div class="uk-card uk-card-default">
                                <div class="uk-card-body">
                                    <form class="uk-grid-small" uk-grid action="<?php echo site_url('staff/PencarianSurat');?>" method="post">
 ...
 <?php 
   ...
   ?>
        ...
        <div class="uk-modal-footer uk-text-right">
            ...
            <a href="<?php echo site_url('staff/excelsuratpegawaiperbulan/'.$NIP.'/'.$bulanModal); ?>" class="uk-button uk-button-primary">Cetak
									</a> 
